...
INSERT INTO lightsabers (hilt_metal, colour, character_id) VALUES ('Palladium', 'red', 2);
INSERT INTO lightsabers (hilt_metal, colour, character_id) VALUES ('Platinum', 'green', 4);

DELETE FROM lightsabers WHERE id = 2;
